...
etcd_service_manager_sysvinit 'etcd0' do
  advertise_client_urls 'http://127.0.0.1:2380'
...
etcd_service_manager_sysvinit 'etcd1' do
...
etcd_service_manager_sysvinit 'etcd2' do
