...
etcd_service_manager_docker 'etcd0' do
  ...
  initial_cluster "etcd0=http://#{node[:ipaddress]}:2380,etcd1=http://#{node[:ipaddress]}:3380,etcd2=http://#{node[:ipaddress]}:4380"
...
etcd_service_manager_docker 'etcd1' do
  advertise_client_urls "http://#{node[:ipaddress]}:3379,http://0.0.0.0:5001"
  listen_client_urls 'http://0.0.0.0:3379,http://0.0.0.0:5001'
  initial_advertise_peer_urls "http://#{node[:ipaddress]}:3380"
...
etcd_service_manager_docker 'etcd2' do
  advertise_client_urls "http://#{node[:ipaddress]}:4379,http://#{node[:ipaddress]}:6001"
  listen_client_urls 'http://0.0.0.0:4379,http://0.0.0.0:6001'
  initial_advertise_peer_urls "http://#{node[:ipaddress]}:4380"
